...
public class AddpositionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<a href=\"addposition.jsp\">back</a>");
            ...
            throws ServletException, IOException 
    {
        ...
        Position position = new Position(request.getParameter("namepos").toLowerCase(), 
                request.getParameter("nrpos").toLowerCase(), 
                request.getParameter("description").toLowerCase(),
                request.getParameter("requirements").toLowerCase().trim());
...
*/
            ...
            ses.setAttribute("positionAdded", (Boolean)true);
